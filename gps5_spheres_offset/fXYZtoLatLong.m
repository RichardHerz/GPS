function [lat, long, a] = fXYZtoLatLong(xyz,r) 
    % rows of input xyz are x, y, z coordinates of a location
    ...
    ra = sqrt(sum(xyz.^2, 2)); % distance from earth center, opt 2 sums each row
